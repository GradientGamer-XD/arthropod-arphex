...
public class Marker1tipProcedure {
   public static boolean execute(Entity entity) {
      if (entity == null) {
         ...
         }).getItemStack(0, entity instanceof LivingEntity _livEntx ? _livEntx.getMainHandItem() : ItemStack.EMPTY).getCount() == 0;
      } else {
         return ArphexModItems.WARP_WAYFINDER.get() == (entity instanceof LivingEntity _livEntx ? _livEntx.getOffhandItem() : ItemStack.EMPTY).getItem()
            ...
            }).getItemStack(0, entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getCount() == 0
            : true;
      }
   }
}

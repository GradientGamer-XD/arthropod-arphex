...
public class TormentorMothSummonOnInitialEntitySpawnProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 8.0, 8.0, 8.0), e -> true).isEmpty()) {
            if (entity instanceof TormentorMothSummonEntity _datEntSetL) {
               _datEntSetL.getEntityData().set(TormentorMothSummonEntity.DATA_playerspawned, true);
            }

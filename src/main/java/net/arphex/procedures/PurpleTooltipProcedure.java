...
public class PurpleTooltipProcedure {
   public static boolean execute(Entity entity) {
      if (entity == null) {
         ...
         return ArphexModItems.SINGULARITY_SATCHEL.get()
            ...
            }).getItemStack(85, entity instanceof LivingEntity _livEntx ? _livEntx.getMainHandItem() : ItemStack.EMPTY).getCount() == 0
            : (new Object() {
               public ItemStack getItemStack(int sltid, ItemStack _isc) {
                  AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
                  _isc.getCapability(ForgeCapabilities.ITEM_HANDLER, null).ifPresent(capability -> _retval.set(capability.getStackInSlot(sltid).copy()));
            ...
            }).getItemStack(85, entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getCount() == 0;
      }
   }
}

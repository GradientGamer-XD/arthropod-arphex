...
public class PlaceholderWarpProcedure {
   public static void execute(Entity entity) {
      if (entity != null) {
         ...
         for (int index0 = 0; index0 < 40; index0++) {
            ...
            }).getItemStack((int)slot_iterate, entity).getItem() == ArphexModItems.WARP_WAYFINDER_PLACEHOLDER.get()) {
               int _slotid = (int)slot_iterate;
               ItemStack _setstack = new ItemStack((ItemLike)ArphexModItems.WARP_WAYFINDER.get()).copy();

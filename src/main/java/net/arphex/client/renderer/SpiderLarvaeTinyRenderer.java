...
public class SpiderLarvaeTinyRenderer extends GeoEntityRenderer<SpiderLarvaeTinyEntity> {
   ...
   public SpiderLarvaeTinyRenderer(Context renderManager) {
      super(renderManager, new SpiderLarvaeTinyModel());
      this.shadowRadius = 0.0F;
      this.addRenderLayer(new SpiderLarvaeTinyLayer(this));
   ...
   public void applyRotations(SpiderLarvaeTinyEntity entity, PoseStack poseStack, float ageInTicks, float netHeadYaw, float partialTick) {

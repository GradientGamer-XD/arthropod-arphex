...
public class CentipedeEvictorLarvaeRenderer extends GeoEntityRenderer<CentipedeEvictorLarvaeEntity> {
   ...
   public CentipedeEvictorLarvaeRenderer(Context renderManager) {
      super(renderManager, new CentipedeEvictorLarvaeModel());
   ...
   public RenderType getRenderType(CentipedeEvictorLarvaeEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
      return RenderType.entityTranslucent(this.getTextureLocation(animatable));
   }

   public void preRender(
      PoseStack poseStack,
      CentipedeEvictorLarvaeEntity entity,
      BakedGeoModel model,
   ...
   public void applyRotations(CentipedeEvictorLarvaeEntity entity, PoseStack poseStack, float ageInTicks, float netHeadYaw, float partialTick) {
   ...
   private boolean tryNyfsRotation(CentipedeEvictorLarvaeEntity entity, PoseStack poseStack, float partialTick) {
      try {

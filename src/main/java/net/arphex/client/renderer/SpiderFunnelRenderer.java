...
public class SpiderFunnelRenderer extends GeoEntityRenderer<SpiderFunnelEntity> {
   ...
   public SpiderFunnelRenderer(Context renderManager) {
      super(renderManager, new SpiderFunnelModel());
      this.shadowRadius = 0.0F;
      this.addRenderLayer(new SpiderFunnelLayer(this));
   ...
   public RenderType getRenderType(SpiderFunnelEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
      return RenderType.entityTranslucent(this.getTextureLocation(animatable));
   }

   public void preRender(
      PoseStack poseStack,
      SpiderFunnelEntity entity,
      BakedGeoModel model,
   ...
   public void applyRotations(SpiderFunnelEntity entity, PoseStack poseStack, float ageInTicks, float netHeadYaw, float partialTick) {
   ...
   private boolean tryNyfsRotation(SpiderFunnelEntity entity, PoseStack poseStack, float partialTick) {
      try {

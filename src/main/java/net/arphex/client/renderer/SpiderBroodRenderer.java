...
import net.arphex.entity.layer.SpiderBroodLayer;
import net.arphex.entity.model.SpiderBroodModel;
...
public class SpiderBroodRenderer extends GeoEntityRenderer<SpiderBroodEntity> {
   ...
   public SpiderBroodRenderer(Context renderManager) {
      super(renderManager, new SpiderBroodModel());
      this.shadowRadius = 0.0F;
      this.addRenderLayer(new SpiderBroodLayer(this));
   ...
   public RenderType getRenderType(SpiderBroodEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
      return RenderType.entityTranslucent(this.getTextureLocation(animatable));
   }

   public void preRender(
      PoseStack poseStack,
      SpiderBroodEntity entity,
      BakedGeoModel model,
   ...
   public void applyRotations(SpiderBroodEntity entity, PoseStack poseStack, float ageInTicks, float netHeadYaw, float partialTick) {
   ...
   private boolean tryNyfsRotation(SpiderBroodEntity entity, PoseStack poseStack, float partialTick) {
      try {

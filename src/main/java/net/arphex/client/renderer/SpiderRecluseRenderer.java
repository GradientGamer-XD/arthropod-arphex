...
import net.arphex.entity.layer.SpiderRecluseLayer;
import net.arphex.entity.model.SpiderRecluseModel;
import net.arphex.procedures.SpiderRecluseEntityVisualScaleProcedure;
...
public class SpiderRecluseRenderer extends GeoEntityRenderer<SpiderRecluseEntity> {
   ...
   public SpiderRecluseRenderer(Context renderManager) {
      super(renderManager, new SpiderRecluseModel());
      this.shadowRadius = 0.0F;
      this.addRenderLayer(new SpiderRecluseLayer(this));
   ...
   public RenderType getRenderType(SpiderRecluseEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
      return RenderType.entityTranslucent(this.getTextureLocation(animatable));
   }

   public void preRender(
      PoseStack poseStack,
      SpiderRecluseEntity entity,
      BakedGeoModel model,
      ...
      float scale = (float)SpiderRecluseEntityVisualScaleProcedure.execute(entity);
      this.scaleHeight = scale;
      this.scaleWidth = scale;
      super.preRender(poseStack, entity, model, bufferSource, buffer, isReRender, partialTick, packedLight, packedOverlay, red, green, blue, alpha);
   }

   public void applyRotations(SpiderRecluseEntity entity, PoseStack poseStack, float ageInTicks, float netHeadYaw, float partialTick) {
   ...
   private boolean tryNyfsRotation(SpiderRecluseEntity entity, PoseStack poseStack, float partialTick) {
      try {
   ...
   protected float getDeathMaxRotation(SpiderRecluseEntity entity) {
      return 0.0F;
   }
}

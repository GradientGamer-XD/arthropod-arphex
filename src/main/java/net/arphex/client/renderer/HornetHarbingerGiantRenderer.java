...
public class HornetHarbingerGiantRenderer extends GeoEntityRenderer<HornetHarbingerGiantEntity> {
   public HornetHarbingerGiantRenderer(Context renderManager) {
      super(renderManager, new HornetHarbingerGiantModel());
      this.shadowRadius = 0.3F;
   }

   public RenderType getRenderType(HornetHarbingerGiantEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
      return RenderType.entityTranslucent(this.getTextureLocation(animatable));
   }

   public void preRender(
      PoseStack poseStack,
      HornetHarbingerGiantEntity entity,
      BakedGeoModel model,

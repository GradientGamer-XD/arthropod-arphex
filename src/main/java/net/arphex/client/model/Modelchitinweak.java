...
public class Modelchitinweak<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("arphex", "modelchitinweak"), "main");
   ...
   public Modelchitinweak(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition HatLayer_r4 = Helmet.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-3.825F, -6.125F, -2.2F, -0.1201F, 0.0412F, -1.2085F)
      );
      PartDefinition HatLayer_r5 = Helmet.addOrReplaceChild(
         "HatLayer_r5",
         CubeListBuilder.create().texOffs(11, 6).addBox(1.5F, -0.5F, 2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.55F)),
         PartPose.offsetAndRotation(3.775F, -6.225F, -2.0F, 0.1379F, 0.0792F, -2.0042F)
      );
      ...
      PartDefinition BodyLayer_r1 = Chestplate.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-4.1F, -0.8F, -0.475F, 0.0F, 0.0F, 1.5752F)
      );
      ...
      PartDefinition RightArmLayer_r1 = RightPlate.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-1.35F, -1.475F, 0.4F, 0.1309F, 0.0F, -0.6109F)
      );
      PartDefinition RightArmLayer_r2 = RightPlate.addOrReplaceChild(
         "RightArmLayer_r2",
         CubeListBuilder.create().texOffs(43, 19).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.55F)),
      ...
      PartDefinition LeftArmLayer_r1 = LeftPlate.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(1.0F, -1.6F, 0.4F, 0.1309F, 0.0F, 0.5585F)
      );
      PartDefinition LeftArmLayer_r2 = LeftPlate.addOrReplaceChild(
         "LeftArmLayer_r2",
         CubeListBuilder.create().texOffs(35, 20).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.55F)),
         PartPose.offsetAndRotation(1.5F, 5.6F, 0.0F, 0.0F, 0.1745F, 0.0F)
      );

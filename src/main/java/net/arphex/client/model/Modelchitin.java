...
public class Modelchitin<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("arphex", "modelchitin"), "main");
   ...
   public Modelchitin(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition HatLayer_r3 = Helmet.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-1.525F, -7.65F, 2.525F, -0.9948F, 0.0F, 0.0F)
      );
      PartDefinition HatLayer_r4 = Helmet.addOrReplaceChild(
         "HatLayer_r4",
         CubeListBuilder.create().texOffs(4, 0).addBox(-0.5F, -0.5F, -6.0F, 4.0F, 1.0F, 8.0F, new CubeDeformation(0.5F)),
      ...
      PartDefinition HatLayer_r7 = Chestplate.addOrReplaceChild(
         "HatLayer_r7",
         CubeListBuilder.create().texOffs(9, 0).addBox(-1.5F, -1.5F, 0.3F, 7.0F, 0.0F, 4.0F, new CubeDeformation(0.5F)),
         PartPose.offsetAndRotation(-2.025F, 9.125F, 1.725F, -1.885F, 0.0F, 0.0F)
      );
      PartDefinition HatLayer_r8 = Chestplate.addOrReplaceChild(
         "HatLayer_r8",
         CubeListBuilder.create().texOffs(9, 19).addBox(-3.5F, -1.5F, -0.7F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.5F)),
      ...
      PartDefinition BodyLayer_r3 = Chestplate.addOrReplaceChild(
         "BodyLayer_r3",
         CubeListBuilder.create().texOffs(19, 23).addBox(-1.0F, -6.0F, -2.0F, 2.0F, 5.0F, 4.0F, new CubeDeformation(0.25F)),
         PartPose.offsetAndRotation(1.5F, 4.3F, -1.1F, 0.0F, 0.0F, 0.4756F)
      );
      PartDefinition BodyLayer_r4 = Chestplate.addOrReplaceChild(
         "BodyLayer_r4",
         CubeListBuilder.create().texOffs(19, 23).addBox(0.0F, -6.0F, -2.0F, 2.0F, 5.0F, 4.0F, new CubeDeformation(0.25F)),
         PartPose.offsetAndRotation(-2.5F, 4.8F, -1.15F, 0.0F, 0.0F, -0.4843F)
      );
      ...
      PartDefinition RightArmLayer_r2 = RightPlate.addOrReplaceChild(
         "RightArmLayer_r2",
         CubeListBuilder.create().texOffs(1, 24).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.55F)),
      ...
      PartDefinition LeftArmLayer_r2 = LeftPlate.addOrReplaceChild(
         "LeftArmLayer_r2",
         CubeListBuilder.create().texOffs(34, 22).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.55F)),
         PartPose.offsetAndRotation(1.5F, 5.6F, 0.0F, 0.0F, 0.1745F, 0.0F)
      );

...
public class Modelchitinstrong<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("arphex", "modelchitinstrong"), "main");
   ...
   public Modelchitinstrong(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition HatLayer_r1 = Helmet.addOrReplaceChild(
         "HatLayer_r1",
         CubeListBuilder.create().texOffs(16, 24).mirror().addBox(-8.5F, -2.5F, 0.3F, 11.0F, 3.0F, 3.0F, new CubeDeformation(0.5F)).mirror(false),
         PartPose.offsetAndRotation(2.925F, -5.125F, 1.95F, -1.6755F, 0.0F, 0.0F)
      );
      PartDefinition HatLayer_r2 = Helmet.addOrReplaceChild(
         "HatLayer_r2",
         CubeListBuilder.create().texOffs(9, 4).addBox(-1.5F, 0.5F, -4.0F, 5.0F, 0.0F, 4.0F, new CubeDeformation(0.55F)),
      ...
      PartDefinition HatLayer_r3 = Helmet.addOrReplaceChild(
         "HatLayer_r3",
         CubeListBuilder.create().texOffs(12, 4).mirror().addBox(-3.5F, 0.5F, -4.0F, 5.0F, 0.0F, 4.0F, new CubeDeformation(0.55F)).mirror(false),
         PartPose.offsetAndRotation(4.925F, -7.65F, -1.175F, 0.2419F, 0.0128F, 0.8382F)
      );
      PartDefinition HatLayer_r4 = Helmet.addOrReplaceChild(
         "HatLayer_r4",
         CubeListBuilder.create().texOffs(4, 4).addBox(-2.5F, -0.5F, -2.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.5F)),
         PartPose.offsetAndRotation(-1.375F, -7.65F, 2.525F, -0.9948F, 0.0F, 0.0F)
      );
      PartDefinition HatLayer_r5 = Helmet.addOrReplaceChild(
         "HatLayer_r5",
         CubeListBuilder.create().texOffs(6, 2).addBox(-0.5F, -0.5F, -6.0F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.5F)),
      ...
      PartDefinition BodyLayer_r1 = Chestplate.addOrReplaceChild(
         "BodyLayer_r1",
         CubeListBuilder.create().texOffs(21, 20).mirror().addBox(-2.0F, -8.0F, -2.0F, 2.0F, 7.0F, 4.0F, new CubeDeformation(0.25F)).mirror(false),
         PartPose.offsetAndRotation(2.5F, 4.7F, -1.15F, 0.0F, 0.0F, 0.4843F)
      );
      PartDefinition HatLayer_r8 = Chestplate.addOrReplaceChild(
         "HatLayer_r8",
         CubeListBuilder.create().texOffs(16, 23).addBox(-2.5F, -1.5F, 0.3F, 9.0F, 0.0F, 4.0F, new CubeDeformation(0.5F)),
         PartPose.offsetAndRotation(-2.025F, 12.325F, 1.725F, -1.885F, 0.0F, 0.0F)
      );
      PartDefinition HatLayer_r9 = Chestplate.addOrReplaceChild(
         "HatLayer_r9",
         CubeListBuilder.create().texOffs(13, 22).addBox(-3.5F, -1.5F, 1.3F, 12.0F, 2.0F, 5.0F, new CubeDeformation(0.5F)),
         PartPose.offsetAndRotation(-2.375F, 7.375F, 1.95F, -1.6755F, 0.0F, 0.0F)
      );
      PartDefinition HatLayer_r10 = Chestplate.addOrReplaceChild(
         "HatLayer_r10",
         CubeListBuilder.create().texOffs(11, 22).addBox(-3.5F, -1.5F, -0.7F, 9.0F, 0.0F, 9.0F, new CubeDeformation(0.5F)),
         PartPose.offsetAndRotation(-0.825F, 1.45F, 3.9F, -1.6755F, 0.0F, 0.0F)
      );
      PartDefinition HatLayer_r11 = Chestplate.addOrReplaceChild(
         "HatLayer_r11",
         CubeListBuilder.create().texOffs(9, 20).addBox(-4.5F, -1.5F, -0.7F, 13.0F, 2.0F, 9.0F, new CubeDeformation(0.5F)),
      ...
      PartDefinition BodyLayer_r2 = Chestplate.addOrReplaceChild(
         "BodyLayer_r2",
         CubeListBuilder.create().texOffs(20, 16).addBox(0.0F, -8.0F, -2.0F, 1.0F, 8.0F, 4.0F, new CubeDeformation(0.25F)),
      ...
      PartDefinition BodyLayer_r4 = Chestplate.addOrReplaceChild(
         "BodyLayer_r4",
         CubeListBuilder.create().texOffs(21, 20).addBox(0.0F, -8.0F, -2.0F, 2.0F, 7.0F, 4.0F, new CubeDeformation(0.25F)),
         PartPose.offsetAndRotation(-2.5F, 4.7F, -1.15F, 0.0F, 0.0F, -0.4843F)
      );
      ...
      PartDefinition RightArmLayer_r1 = RightPlate.addOrReplaceChild(
         "RightArmLayer_r1",
         CubeListBuilder.create().texOffs(39, 15).mirror().addBox(-2.0F, -1.0F, -3.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.25F)).mirror(false),
      ...
      PartDefinition RightArmLayer_r2 = RightPlate.addOrReplaceChild(
         "RightArmLayer_r2",
         CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.55F)),
      ...
      PartDefinition LeftArmLayer_r2 = LeftPlate.addOrReplaceChild(
         "LeftArmLayer_r2",
         CubeListBuilder.create().texOffs(40, 16).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.55F)),
         PartPose.offsetAndRotation(1.5F, 5.6F, 0.0F, 0.0F, 0.1745F, 0.0F)
      );
      PartDefinition RightLegging = partdefinition.addOrReplaceChild(
         "RightLegging",
         CubeListBuilder.create().texOffs(40, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.25F)),
         PartPose.offset(-1.9F, 12.0F, 0.0F)
      );
      PartDefinition LeftLegging = partdefinition.addOrReplaceChild(
         "LeftLegging",
         CubeListBuilder.create().texOffs(39, 14).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.25F)),
         PartPose.offset(1.9F, 12.0F, 0.0F)
      );

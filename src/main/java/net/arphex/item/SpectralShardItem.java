...
public class SpectralShardItem extends Item {
   public SpectralShardItem() {
   ...
   public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.literal("§1A life-draining, horrifying alloy shard harbouring enormous power"));
   }

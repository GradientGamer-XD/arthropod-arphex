...
import net.arphex.procedures.CelestialBarrierPlayerFinishesUsingItemProcedure;
...
public class CelestialBarrierItem extends Item {
   public CelestialBarrierItem() {
   ...
   public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.literal("Consume to unlock the special §l§6Celestial Mirror Power"));
      list.add(
         Component.literal(
            "§bThis power enables you to summon powerful shields that reflect most ranged attacks and repel mobs - shields work based on your direction"
         )
      );
   ...
   public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
      ...
      CelestialBarrierPlayerFinishesUsingItemProcedure.execute(world, x, y, z, entity);
      return retval;
   }

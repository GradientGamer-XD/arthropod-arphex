...
import net.arphex.procedures.SlingWebItemInHandTickProcedure;
...
public class SilkSlingerItem extends Item {
   public SilkSlingerItem() {
   ...
   public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.literal("Web-based grappling hook "));
      list.add(
         Component.literal(
   ...
   public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
      ...
      if (selected) {
         SlingWebItemInHandTickProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
      }

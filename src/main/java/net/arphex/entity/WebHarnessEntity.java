...
import net.arphex.procedures.WebHarnessOnEntityTickUpdateProcedure;
import net.arphex.procedures.WebHarnessOnInitialEntitySpawnProcedure;
...
public class WebHarnessEntity extends PathfinderMob {
   public WebHarnessEntity(SpawnEntity packet, Level world) {
      this((EntityType<WebHarnessEntity>)ArphexModEntities.WEB_HARNESS.get(), world);
   }

   public WebHarnessEntity(EntityType<WebHarnessEntity> type, Level world) {
      super(type, world);
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      WebHarnessOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
      return retval;
   }

   public void baseTick() {
      super.baseTick();
      WebHarnessOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }

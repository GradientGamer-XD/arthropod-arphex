...
public class TormentorLowDisplayEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TormentorLowDisplayEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TormentorLowDisplayEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TormentorLowDisplayEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_tormenttimer = SynchedEntityData.defineId(TormentorLowDisplayEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<String> DATA_tormentcycle = SynchedEntityData.defineId(TormentorLowDisplayEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_tormentswitch = SynchedEntityData.defineId(TormentorLowDisplayEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_time_since_attacked = SynchedEntityData.defineId(
      TormentorLowDisplayEntity.class, EntityDataSerializers.INT
   );
   ...
   public TormentorLowDisplayEntity(SpawnEntity packet, Level world) {
      this((EntityType<TormentorLowDisplayEntity>)ArphexModEntities.TORMENTOR_LOW_DISPLAY.get(), world);
   }

   public TormentorLowDisplayEntity(EntityType<TormentorLowDisplayEntity> type, Level world) {
      super(type, world);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tormentor2");
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new RandomLookAroundGoal(this) {
         public boolean canUse() {
            double x = TormentorLowDisplayEntity.this.getX();
            double y = TormentorLowDisplayEntity.this.getY();
            double z = TormentorLowDisplayEntity.this.getZ();
            Entity entity = TormentorLowDisplayEntity.this;
            Level world = TormentorLowDisplayEntity.this.level();
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.tormentor.splay")) : PlayState.STOP;
   }

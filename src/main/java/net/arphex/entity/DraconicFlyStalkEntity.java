...
import net.arphex.procedures.DraconicCloneEntityIsHurtProcedure;
import net.arphex.procedures.DraconicCloneOnEntityTickUpdateProcedure;
...
public class DraconicFlyStalkEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DraconicFlyStalkEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DraconicFlyStalkEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DraconicFlyStalkEntity.class, EntityDataSerializers.STRING);
   ...
   public DraconicFlyStalkEntity(SpawnEntity packet, Level world) {
      this((EntityType<DraconicFlyStalkEntity>)ArphexModEntities.DRACONIC_FLY_STALK.get(), world);
   }

   public DraconicFlyStalkEntity(EntityType<DraconicFlyStalkEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "draconicvoidlasherpower");
   }
   ...
   public boolean hurt(DamageSource source, float amount) {
      DraconicCloneEntityIsHurtProcedure.execute(this, source.getEntity());
   ...
   public void baseTick() {
      super.baseTick();
      DraconicCloneOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register(
         (EntityType)ArphexModEntities.DRACONIC_FLY_STALK.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.dvl.aggressivefly")) : PlayState.STOP;
   }

...
public class DraconicCloneEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DraconicCloneEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DraconicCloneEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DraconicCloneEntity.class, EntityDataSerializers.STRING);
   ...
   public DraconicCloneEntity(SpawnEntity packet, Level world) {
      this((EntityType<DraconicCloneEntity>)ArphexModEntities.DRACONIC_CLONE.get(), world);
   }

   public DraconicCloneEntity(EntityType<DraconicCloneEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   public static void init() {
      SpawnPlacements.register(
         (EntityType)ArphexModEntities.DRACONIC_CLONE.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
            int x = pos.getX();
            int y = pos.getY();
            int z = pos.getZ();
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.dvl.idleaggro")) : PlayState.STOP;
   }

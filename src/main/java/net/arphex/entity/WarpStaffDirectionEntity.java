...
import net.arphex.procedures.WarpStaffDirectionOnEntityTickUpdateProcedure;
...
public class WarpStaffDirectionEntity extends Monster {
   public WarpStaffDirectionEntity(SpawnEntity packet, Level world) {
      this((EntityType<WarpStaffDirectionEntity>)ArphexModEntities.WARP_STAFF_DIRECTION.get(), world);
   }

   public WarpStaffDirectionEntity(EntityType<WarpStaffDirectionEntity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      WarpStaffDirectionOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }

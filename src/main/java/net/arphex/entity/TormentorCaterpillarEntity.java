...
import net.arphex.procedures.TormentorCaterpillarOnEntityTickUpdateProcedure;
import net.arphex.procedures.TormentorCaterpillarOnInitialEntitySpawnProcedure;
...
public class TormentorCaterpillarEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TormentorCaterpillarEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TormentorCaterpillarEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TormentorCaterpillarEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> DATA_currentattack = SynchedEntityData.defineId(
      TormentorCaterpillarEntity.class, EntityDataSerializers.STRING
   );
   public static final EntityDataAccessor<Integer> DATA_attacktimer = SynchedEntityData.defineId(TormentorCaterpillarEntity.class, EntityDataSerializers.INT);
   ...
   public TormentorCaterpillarEntity(SpawnEntity packet, Level world) {
      this((EntityType<TormentorCaterpillarEntity>)ArphexModEntities.TORMENTOR_CATERPILLAR.get(), world);
   }

   public TormentorCaterpillarEntity(EntityType<TormentorCaterpillarEntity> type, Level world) {
      super(type, world);
      this.xpReward = 200;
      this.setNoAi(true);
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      TormentorCaterpillarOnInitialEntitySpawnProcedure.execute(this);
      return retval;
   }
   ...
   public void baseTick() {
      super.baseTick();
      TormentorCaterpillarOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
      this.refreshDimensions();
   }

   public EntityDimensions getDimensions(Pose p_33597_) {
      return super.getDimensions(p_33597_).scale(1.9F);
   }

...
public class TormentorLowDisplayAnimEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TormentorLowDisplayAnimEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TormentorLowDisplayAnimEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TormentorLowDisplayAnimEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_tormenttimer = SynchedEntityData.defineId(
      TormentorLowDisplayAnimEntity.class, EntityDataSerializers.INT
   );
   public static final EntityDataAccessor<String> DATA_tormentcycle = SynchedEntityData.defineId(
      TormentorLowDisplayAnimEntity.class, EntityDataSerializers.STRING
   );
   public static final EntityDataAccessor<Integer> DATA_tormentswitch = SynchedEntityData.defineId(
      TormentorLowDisplayAnimEntity.class, EntityDataSerializers.INT
   );
   ...
   public TormentorLowDisplayAnimEntity(SpawnEntity packet, Level world) {
      this((EntityType<TormentorLowDisplayAnimEntity>)ArphexModEntities.TORMENTOR_LOW_DISPLAY_ANIM.get(), world);
   }

   public TormentorLowDisplayAnimEntity(EntityType<TormentorLowDisplayAnimEntity> type, Level world) {
      super(type, world);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new RandomLookAroundGoal(this) {
         public boolean canUse() {
            double x = TormentorLowDisplayAnimEntity.this.getX();
            double y = TormentorLowDisplayAnimEntity.this.getY();
            double z = TormentorLowDisplayAnimEntity.this.getZ();
            Entity entity = TormentorLowDisplayAnimEntity.this;
            Level world = TormentorLowDisplayAnimEntity.this.level();

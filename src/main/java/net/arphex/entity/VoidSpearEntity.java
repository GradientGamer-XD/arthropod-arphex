...
import net.arphex.procedures.VoidSpearProjectileHitsBlockProcedure;
import net.arphex.procedures.VoidSpearProjectileHitsLivingEntityProcedure;
import net.arphex.procedures.VoidSpearWhileProjectileFlyingTickProcedure;
...
public class VoidSpearEntity extends AbstractArrow implements ItemSupplier {
   ...
   public VoidSpearEntity(SpawnEntity packet, Level world) {
      super((EntityType)ArphexModEntities.VOID_SPEAR.get(), world);
   }
   ...
   public void onHitEntity(EntityHitResult entityHitResult) {
      ...
      VoidSpearProjectileHitsLivingEntityProcedure.execute(
   ...
   public void onHitBlock(BlockHitResult blockHitResult) {
      ...
      VoidSpearProjectileHitsBlockProcedure.execute(
         this.level(),
   ...
   public void tick() {
      super.tick();
      VoidSpearWhileProjectileFlyingTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this.getOwner(), this);
      if (this.inGround) {
         this.discard();
      }
   }

   public static VoidSpearEntity shoot(Level world, LivingEntity entity, RandomSource source) {
   ...
   public static VoidSpearEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      VoidSpearEntity entityarrow = new VoidSpearEntity((EntityType<? extends VoidSpearEntity>)ArphexModEntities.VOID_SPEAR.get(), entity, world);
   ...
   public static VoidSpearEntity shoot(LivingEntity entity, LivingEntity target) {
      VoidSpearEntity entityarrow = new VoidSpearEntity((EntityType<? extends VoidSpearEntity>)ArphexModEntities.VOID_SPEAR.get(), entity, entity.level());

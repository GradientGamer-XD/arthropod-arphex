...
import net.arphex.procedures.TormentorVoidlasherSummonOnEntityTickUpdateProcedure;
import net.arphex.procedures.TormentorVoidlasherSummonOnInitialEntitySpawnProcedure;
...
public class TormentorVoidlasherSummonEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TormentorVoidlasherSummonEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TormentorVoidlasherSummonEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TormentorVoidlasherSummonEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> DATA_currentattack = SynchedEntityData.defineId(
      TormentorVoidlasherSummonEntity.class, EntityDataSerializers.STRING
   );
   public static final EntityDataAccessor<Integer> DATA_attacktimer = SynchedEntityData.defineId(
      TormentorVoidlasherSummonEntity.class, EntityDataSerializers.INT
   );
   ...
   public TormentorVoidlasherSummonEntity(SpawnEntity packet, Level world) {
      this((EntityType<TormentorVoidlasherSummonEntity>)ArphexModEntities.TORMENTOR_VOIDLASHER_SUMMON.get(), world);
   }

   public TormentorVoidlasherSummonEntity(EntityType<TormentorVoidlasherSummonEntity> type, Level world) {
      super(type, world);
      this.xpReward = 500;
      this.setNoAi(false);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "tormentlasher");
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      TormentorVoidlasherSummonOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
      return retval;
   }
   ...
   public void baseTick() {
      super.baseTick();
      TormentorVoidlasherSummonOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init() {
      SpawnPlacements.register(
         (EntityType)ArphexModEntities.TORMENTOR_VOIDLASHER_SUMMON.get(),
         Type.ON_GROUND,
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (!this.animationprocedure.equals("empty")) {
         ...
         return event.setAndContinue(RawAnimation.begin().thenLoop("animation.dvl.aggressivefly"));
         ...
         return !this.onGround()
            ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.dvl.aggressivefly"))
            : event.setAndContinue(RawAnimation.begin().thenLoop("animation.dvl.aggressivefly"));
      }
   }

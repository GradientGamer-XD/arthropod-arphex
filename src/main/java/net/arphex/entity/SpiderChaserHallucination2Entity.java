...
public class SpiderChaserHallucination2Entity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SpiderChaserHallucination2Entity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SpiderChaserHallucination2Entity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SpiderChaserHallucination2Entity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_random_size = SynchedEntityData.defineId(
      SpiderChaserHallucination2Entity.class, EntityDataSerializers.INT
   );
   ...
   public SpiderChaserHallucination2Entity(SpawnEntity packet, Level world) {
      this((EntityType<SpiderChaserHallucination2Entity>)ArphexModEntities.SPIDER_CHASER_HALLUCINATION_2.get(), world);
   }

   public SpiderChaserHallucination2Entity(EntityType<SpiderChaserHallucination2Entity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(7, new RandomStrollGoal(this, 1.5, 20) {
         protected Vec3 getPosition() {
            RandomSource random = SpiderChaserHallucination2Entity.this.getRandom();
            double dir_x = SpiderChaserHallucination2Entity.this.getX() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
            double dir_y = SpiderChaserHallucination2Entity.this.getY() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
            double dir_z = SpiderChaserHallucination2Entity.this.getZ() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
   ...
   public static void init() {
      SpawnPlacements.register(
         (EntityType)ArphexModEntities.SPIDER_CHASER_HALLUCINATION_2.get(),
         Type.ON_GROUND,
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.spiderfunnel.scurrying")) : PlayState.STOP;
   }

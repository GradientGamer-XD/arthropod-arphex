...
import net.arphex.procedures.RepellantTickProcedure;
...
public class RepellantEntity extends Monster {
   public RepellantEntity(SpawnEntity packet, Level world) {
      this((EntityType<RepellantEntity>)ArphexModEntities.REPELLANT.get(), world);
   }

   public RepellantEntity(EntityType<RepellantEntity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      RepellantTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }

...
public class GiantEnemySpiderEntity extends Spider implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GiantEnemySpiderEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GiantEnemySpiderEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GiantEnemySpiderEntity.class, EntityDataSerializers.STRING);
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   private boolean swinging;
   private boolean lastloop;
   private long lastSwing;
   public String animationprocedure = "empty";
   private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), BossBarColor.PINK, BossBarOverlay.PROGRESS);

   public GiantEnemySpiderEntity(SpawnEntity packet, Level world) {
      this((EntityType<GiantEnemySpiderEntity>)ArphexModEntities.GIANT_ENEMY_SPIDER.get(), world);
   }

   public GiantEnemySpiderEntity(EntityType<GiantEnemySpiderEntity> type, Level world) {
      super(type, world);
      this.xpReward = 200;
      this.setNoAi(true);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "giant_enemy_spider");
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.giantenemyspider.idle")) : PlayState.STOP;
   }

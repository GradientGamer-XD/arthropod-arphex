...
public class SpiderRecluseDisplayLayer extends GeoRenderLayer<SpiderRecluseDisplayEntity> {
   private static final ResourceLocation LAYER = new ResourceLocation("arphex", "textures/entities/spider_ambush_glow.png");

   public SpiderRecluseDisplayLayer(GeoRenderer<SpiderRecluseDisplayEntity> entityRenderer) {
      super(entityRenderer);
   }

   public void render(
      PoseStack poseStack,
      SpiderRecluseDisplayEntity animatable,

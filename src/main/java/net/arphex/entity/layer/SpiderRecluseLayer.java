...
public class SpiderRecluseLayer extends GeoRenderLayer<SpiderRecluseEntity> {
   private static final ResourceLocation LAYER = new ResourceLocation("arphex", "textures/entities/spider_ambush_glow.png");

   public SpiderRecluseLayer(GeoRenderer<SpiderRecluseEntity> entityRenderer) {
      super(entityRenderer);
   }

   public void render(
      PoseStack poseStack,
      SpiderRecluseEntity animatable,

...
public class SpiderAmbusherLayer extends GeoRenderLayer<SpiderAmbusherEntity> {
   private static final ResourceLocation LAYER = new ResourceLocation("arphex", "textures/entities/spider_ambush_glow.png");

   public SpiderAmbusherLayer(GeoRenderer<SpiderAmbusherEntity> entityRenderer) {
      super(entityRenderer);
   }

   public void render(
      PoseStack poseStack,
      SpiderAmbusherEntity animatable,

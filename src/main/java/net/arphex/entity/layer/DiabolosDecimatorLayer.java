...
public class DiabolosDecimatorLayer extends GeoRenderLayer<DiabolosDecimatorEntity> {
   private static ResourceLocation getLayer(DiabolosDecimatorEntity animatable) {
   ...
   public DiabolosDecimatorLayer(GeoRenderer<DiabolosDecimatorEntity> entityRenderer) {
      super(entityRenderer);
   }

   public void render(
      PoseStack poseStack,
      DiabolosDecimatorEntity animatable,

...
public class TormentorFlashAnimEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TormentorFlashAnimEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TormentorFlashAnimEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TormentorFlashAnimEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_tormenttimer = SynchedEntityData.defineId(TormentorFlashAnimEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<String> DATA_tormentcycle = SynchedEntityData.defineId(TormentorFlashAnimEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_tormentswitch = SynchedEntityData.defineId(TormentorFlashAnimEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_time_since_attacked = SynchedEntityData.defineId(
      TormentorFlashAnimEntity.class, EntityDataSerializers.INT
   );
   ...
   public TormentorFlashAnimEntity(SpawnEntity packet, Level world) {
      this((EntityType<TormentorFlashAnimEntity>)ArphexModEntities.TORMENTOR_FLASH_ANIM.get(), world);
   }

   public TormentorFlashAnimEntity(EntityType<TormentorFlashAnimEntity> type, Level world) {
      super(type, world);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new RandomLookAroundGoal(this) {
         public boolean canUse() {
            double x = TormentorFlashAnimEntity.this.getX();
            double y = TormentorFlashAnimEntity.this.getY();
            double z = TormentorFlashAnimEntity.this.getZ();
            Entity entity = TormentorFlashAnimEntity.this;
            Level world = TormentorFlashAnimEntity.this.level();
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty")
         ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.tormentor_forceanim.idle"))
         : PlayState.STOP;
   }

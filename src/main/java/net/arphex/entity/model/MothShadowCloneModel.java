...
public class MothShadowCloneModel extends GeoModel<MothShadowCloneEntity> {
   ...
   public void setCustomAnimations(MothShadowCloneEntity animatable, long instanceId, AnimationState animationState) {

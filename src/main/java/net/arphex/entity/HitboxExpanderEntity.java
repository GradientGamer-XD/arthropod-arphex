...
import net.arphex.procedures.ExpandHitboxProcedure;
...
public class HitboxExpanderEntity extends Monster {
   public HitboxExpanderEntity(SpawnEntity packet, Level world) {
      this((EntityType<HitboxExpanderEntity>)ArphexModEntities.HITBOX_EXPANDER.get(), world);
   }

   public HitboxExpanderEntity(EntityType<HitboxExpanderEntity> type, Level world) {
      super(type, world);
   ...
   public void baseTick() {
      super.baseTick();
      ExpandHitboxProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }

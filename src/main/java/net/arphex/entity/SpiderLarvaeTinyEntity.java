...
import net.arphex.procedures.SpiderLarvaeTinyOnInitialEntitySpawnProcedure;
...
public class SpiderLarvaeTinyEntity extends Spider implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SpiderLarvaeTinyEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SpiderLarvaeTinyEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SpiderLarvaeTinyEntity.class, EntityDataSerializers.STRING);
   ...
   public SpiderLarvaeTinyEntity(SpawnEntity packet, Level world) {
      this((EntityType<SpiderLarvaeTinyEntity>)ArphexModEntities.SPIDER_LARVAE_TINY.get(), world);
   }

   public SpiderLarvaeTinyEntity(EntityType<SpiderLarvaeTinyEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, Bat.class, true, true));
      ...
      this.goalSelector.addGoal(9, new RandomStrollGoal(this, 1.3));
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      SpiderLarvaeTinyOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
      return retval;
   }

...
import net.arphex.procedures.ChaserScorpioidHallucinationSpawnProcedure;
...
public class ScorpioidChaserHallucinationEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ScorpioidChaserHallucinationEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ScorpioidChaserHallucinationEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ScorpioidChaserHallucinationEntity.class, EntityDataSerializers.STRING);
   ...
   public ScorpioidChaserHallucinationEntity(SpawnEntity packet, Level world) {
      this((EntityType<ScorpioidChaserHallucinationEntity>)ArphexModEntities.SCORPIOID_CHASER_HALLUCINATION.get(), world);
   }

   public ScorpioidChaserHallucinationEntity(EntityType<ScorpioidChaserHallucinationEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "scorpioidchaser");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(7, new RandomStrollGoal(this, 1.5, 20) {
         protected Vec3 getPosition() {
            RandomSource random = ScorpioidChaserHallucinationEntity.this.getRandom();
            double dir_x = ScorpioidChaserHallucinationEntity.this.getX() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
            double dir_y = ScorpioidChaserHallucinationEntity.this.getY() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
            double dir_z = ScorpioidChaserHallucinationEntity.this.getZ() + (double)((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
   ...
   public SpawnGroupData finalizeSpawn(
      ...
      ChaserScorpioidHallucinationSpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
      return retval;
   }
   ...
   public static void init() {
      SpawnPlacements.register(
         (EntityType)ArphexModEntities.SCORPIOID_CHASER_HALLUCINATION.get(),
         Type.ON_GROUND,

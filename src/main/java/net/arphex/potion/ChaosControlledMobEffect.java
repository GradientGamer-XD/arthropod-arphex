...
import net.arphex.procedures.ChaosControlledActiveTickConditionProcedure;
...
public class ChaosControlledMobEffect extends MobEffect {
   public ChaosControlledMobEffect() {
      super(MobEffectCategory.HARMFUL, -10092442);
   }

   public void applyEffectTick(LivingEntity entity, int amplifier) {
      ChaosControlledActiveTickConditionProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity);
   }
